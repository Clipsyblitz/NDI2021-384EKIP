...
export default function DecenniePage (props){
    ...
    return(
        <> 
        {/* Attention vérifer que split fonctionne*/}
        <h1 className="flex items-center flex-col text-3xl py-8 text-red-400">Actes de sauvetage et d’assistance en mer entre {props.decennie.split('-')[0]} et {props.decennie.split('-')[1]} </h1>
