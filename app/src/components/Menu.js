...
function Menu(props) {
    ...
    const [searchValue, setSearchValue] = useState("Bellatrix")
    const translate = {
        "Bateau": "boat",
        "Sauveur": "rescuer",
    }
        ...
        <div className="menu flex justify-between h-16 shadow-md">
            ...
            <div className="flex items-center mr-2">
                <div>
                    ...
                    <input onBlur={() => search()} onChange={(e) => setSearchValue(e.target.value)} defaultValue="Bellatrix" className="border-l-2 bg-gray-100 p-1 rounded-r-xl h-8" type="text" />
                </div>
