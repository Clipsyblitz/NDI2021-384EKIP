    ...
    return (
        <div className="description flex flex-wrap flex-col content-center mt-8 mb-8 shadow-md pb-16">
            ...
            <div className="flex justify-around text-lg mb-8">
                <p onClick={() => setSelected("18")} className={`${linkStyle} ${selected === "18" ? " bg-red-200" : "hover:border-b-2 hover:border-red-400"}`}>18eme siècle</p>
                <p onClick={() => setSelected("19")} className={`${linkStyle} ${selected === "19" ? " bg-red-200" : "hover:border-b-2 hover:border-red-400"}`} >19eme siècle</p>
                <p onClick={() => setSelected("20")} className={`${linkStyle} ${selected === "20" ? " bg-red-200" : "hover:border-b-2 hover:border-red-400"}`} >20eme siècle</p>
                <p onClick={() => setSelected("21")} className={`${linkStyle} ${selected === "21" ? " bg-red-200" : "hover:border-b-2 hover:border-red-400"}`} >SNSM 21eme siècle</p>
            </div>
